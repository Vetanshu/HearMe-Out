  ...
  return (
    <>
      <div className='min-h-svh'>
        <div className="w-full bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-50 border border-none flex justify-evenly text-3xl p-5 px-24 font-serif font-semibold" id='about'>
          <h1>Who We Are?</h1>
          <h1>What We Do?</h1>
          <h1>Why We Do?</h1>
        </div>
